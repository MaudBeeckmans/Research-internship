...
used_reps = 1000 # The number of repetitions per participant that will be used to estimate the parameter(s)
...
simul_folder = 'Simulations_group{}'.format(group)
estim_folder = 'Estimations_group{}'.format(group)
